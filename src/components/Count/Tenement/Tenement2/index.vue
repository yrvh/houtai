<template>
  <main-card title="解除绑定">
    <div slot="content">
      <div class="clientInfo2-top">
        <el-input class="clientInfo2-input" placeholder="所属年月" v-model="queryInfo.query" clearable @clear="getCommunicateList">
        ...
        <el-button type="primary" class="clientInfo2-search" @click="getCommunicateList"><i class="iconfont icon-search"></i>搜索</el-button>
        <el-button type="danger" class="clientInfo2-clear" @click="getCommunicateList">清空</el-button>
      </div>
      <div>
        <el-button class="clientInfo2-add" @click="addDialogVisible = true"><i class="iconfont icon-refresh"></i>刷新</el-button>
      </div>
...
<style scoped>
  .clientInfo2-top { height: 150px; display: flex; align-items: center; flex-wrap: wrap; border-bottom: 1px solid #eee;}
  .clientInfo2-input { width: 250px; margin-right: 20px;}
  .clientInfo2-search { width: 85px; color: #fff; margin: 0 20px; }
  .clientInfo2-date-picker { }
  .clientInfo2-clear { width: 85px; color: #fff;}

  .clientInfo2-add { background-color: #06D673; color: #fff; margin: 20px 15px 0 0;}
</style>