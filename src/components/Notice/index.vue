    ...
    <div slot="content">
      <div class="account-top">
        ...
        <div class="account-add">
          <el-button type="primary" size="small" @click="addDialogVisible = true"><i class="iconfont icon-add"></i>添加公告</el-button>
        </div>
      </div>
      ...
      <el-table :data="accountList" stripe :header-cell-style="getRowClass">
        ...
        <el-table-column label="标题" prop="account_name"></el-table-column>
        <el-table-column label="发布时间" prop="account_password"></el-table-column>
        <el-table-column label="置顶" prop="role_name"></el-table-column>
