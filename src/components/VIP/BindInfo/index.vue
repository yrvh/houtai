  ...
  <main-card2 title1="会员用户" title2="绑定信息">
    <div slot="content">
      ...
      <el-table :data="accountList" stripe :header-cell-style="getRowClass">
        ...
        <el-table-column label="房间号" prop="account_name"></el-table-column>
        <el-table-column label="绑定人" prop="account_password"></el-table-column>
        <el-table-column label="身份" prop="role_name"></el-table-column>
        <el-table-column label="户主姓名" prop="ctime"></el-table-column>
