    ...
    <div slot="content">
      <div class="deals-top">
        ...
        <div class="second-line">
          <el-button class="button-primary" size="small" @click="addDialogVisible = true"><i class="iconfont icon-add"></i>新建缴费</el-button>
          ...
          <el-button class="button-primary" size="small" @click="addDialogVisible = true"><i class="iconfont icon-add"></i>生成订单</el-button>
        </div>
      </div>
