<!-- 小区管理下的   小区设置-->
<template>
  <main-card title="小区设置">
    <div slot="content">
      <div class="count2-house">
        <div class="count2-houseNum count2-houseChild">小区总户数(户):<span> {{6544}}</span></div>
        <div class="count2-houseRent count2-houseChild">小区总租户(户):<span> {{698}}</span></div>
      </div>
      <div class="count2-export">
        <el-button type="primary"><i class="iconfont icon-export"></i>导出数据</el-button>
      </div>
...
<style scoped>
  .count2-house { display: flex; justify-content: space-between;  margin: 34px 0 26px 0;}
  .count2-houseChild { width: 49%; height: 120px; border-radius: 4px; border: 1px solid #06D673; line-height: 120px; text-align: center;}
  .count2-houseChild span { font-size: 24px; color: #06D673; font-weight: 700; }
  .count2-export { width: 100%; height: 42px;}
  .count2-export>.el-button { float: right; }
</style>