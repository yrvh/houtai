...
<style scoped>
  .login-container {height: 100%; background: rgba(0,0,0,0) url("../../../public/img/loginBG2.png") no-repeat scroll;background-size:100% 100%; display: flex;justify-content: center; align-items: center;}

  /*.login-box { background-color: #FF267e; }*/
  .login-info {width: 400px; height: 502px; border-radius: 4px; background-color: #FFF; position: relative; }
  .login-avatar {width:90px; height: 90px; border: 1px solid #f8f8f8; border-radius: 50%; padding: 1px;box-shadow: 0 0 10px #2290EF; position: absolute;left: 50%;transform: translate(-50%,-50%)}
  ...
  .copyright { margin-top:24px; height: 40px; width: 100%; font-size: 12px; color: #fff; display: flex; flex-direction: column; justify-content: space-between; align-items: center; }
</style>