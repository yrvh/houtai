      ...
      <el-aside :width="isCollapse? '64px':'200px'">
        ...
        <el-menu text-color="#fff" active-text-color="#fff"
          ...
          <el-submenu index="2">
            ...
            <el-menu-item index="/xiaoma/count1">
              <template slot="title">
                <i class="iconfont icon-headerAside-count1"></i>
                <span>小区总数</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/xiaoma/count2">
              <template slot="title">
                <i class="iconfont icon-headerAside-count2"></i>
                <span>小区户数</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/xiaoma/count3">
              <template slot="title">
          ...
          <el-submenu index="4">
            ...
            <el-menu-item index="/xiaoma/clientInfo1">
              <template slot="title">
                <i class="iconfont icon-headerAside-clientInfo1"></i>
                <span>住户档案管理</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/xiaoma/clientInfo2">
              <template slot="title">
          ...
          <el-submenu index="5">
            ...
            <el-menu-item index="/xiaoma/payment1">
              <template slot="title">
                <i class="iconfont icon-headerAside-payment1"></i>
                <span>余额管理</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/xiaoma/payment2">
              <template slot="title">
          ...
          <el-submenu index="7">
            ...
            <el-menu-item index="/xiaoma/user1">
              <template slot="title">
                <i class="iconfont icon-headerAside-user1"></i>
                <span>账号管理</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/xiaoma/user2">
              <template slot="title">
                <i class="iconfont icon-headerAside-user2"></i>
                <span>角色管理</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/xiaoma/user3">
              <template slot="title">
          ...
          <el-submenu index="8">
            ...
            <el-menu-item index="/xiaoma/approval1">
              <template slot="title">
                <i class="iconfont icon-headerAside-approval1"></i>
                <span>账单修改审批</span>
              </template>
          ...
          <el-submenu index="9">
            ...
            <el-menu-item index="/xiaoma/note1">
              <template slot="title">
                <i class="iconfont icon-headerAside-note1"></i>
                <span>短信发送</span>
              </template>
            </el-menu-item>
            <el-menu-item index="/xiaoma/note2">
              <template slot="title">
